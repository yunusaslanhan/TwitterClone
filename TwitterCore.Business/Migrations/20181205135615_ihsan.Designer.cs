...
namespace TwitterCore.Business.Migrations
{
    ...
    [Migration("20181205135615_ihsan")]
    partial class ihsan
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TwitterCore.Domain.Entities.Message", b =>
                {
                    ...
                    b.Property<int?>("fromMessageUserId");

                    b.Property<int?>("toMessageUserId");

                    b.HasKey("MessageId");

                    b.HasIndex("fromMessageUserId");

                    b.HasIndex("toMessageUserId");
            ...
            modelBuilder.Entity("TwitterCore.Domain.Entities.Message", b =>
                {
                    b.HasOne("TwitterCore.Domain.Entities.User", "fromMessage")
                        .WithMany("FromMessage")
                        .HasForeignKey("fromMessageUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("TwitterCore.Domain.Entities.User", "toMessage")
                        .WithMany("ToMessage")
                        .HasForeignKey("toMessageUserId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
